...
class PPO:
    def __init__(self, state_dim, action_dim, lr_actor, lr_critic, gamma, K_epochs, eps_clip, has_continuous_action_space, action_std_init, device):
    ...
    def update_ppo(self):
        ...
        old_states = Batch.from_data_list(self.buffer.states).to(self.device)
